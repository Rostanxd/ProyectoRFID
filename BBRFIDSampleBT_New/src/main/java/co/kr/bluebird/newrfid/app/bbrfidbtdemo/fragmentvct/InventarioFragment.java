...
public class InventarioFragment extends Fragment {
    ...
    private static final String TAG = InventarioFragment.class.getSimpleName();
    ...
    private static class InfoHandler extends Handler {
        private final WeakReference<InventarioFragment> mExecutor;
        public InfoHandler(InventarioFragment f) {
            mExecutor = new WeakReference<>(f);
        }

        @Override
        public void handleMessage(Message msg) {
            InventarioFragment executor = mExecutor.get();
            if (executor != null) {
